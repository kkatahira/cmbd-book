  ...
  for ( i in 1:N ) {
    ...
    for ( t in 1:T ) {
      ...
      if (t < T) {
        ...
        // unchosen action
        Q[3-c[i,t], t+1] = (1-alphaF[i]) * Q[3-c[i,t], t];
      }
    }
  }
}
